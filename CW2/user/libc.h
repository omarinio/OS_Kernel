...
#define SYS_CLOSE_PIPE  ( 0x09 )
#define SYS_READ_PIPE   ( 0x10 )
#define SYS_WRITE_PIPE  ( 0x11 )
#define SYS_PID         ( 0x12 )
...
extern void sem_wait(void * semaphore);
extern void sem_post(void * semaphore);

extern int createPipe( pid_t send, pid_t recieve );
extern void writePipe( int id, uint32_t data );
extern int readPipe( int id );
